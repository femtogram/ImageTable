...
def _draw_font(cr, x, y, font_name, text, align, wrap_width):
	cr.save()
...
def draw_font_left(cr, x, y, font_name, text):
	return _draw_font(cr, x, y, font_name, text, 'left', None)

def draw_font_right(cr, x, y, font_name, text):
	return _draw_font(cr, x, y, font_name, text, 'right', None)

def draw_font_center(cr, x, y, font_name, text):
	return _draw_font(cr, x, y, font_name, text, 'center', None)

def draw_font_left_wrap(cr, x, y, font_name, text, wrap_width):
	return _draw_font(cr, x, y, font_name, text, 'left', wrap_width)

def draw_font_right_wrap(cr, x, y, font_name, text, wrap_width):
	return _draw_font(cr, x, y, font_name, text, 'right', wrap_width)

def draw_font_center_wrap(cr, x, y, font_name, text, wrap_width):
	return _draw_font(cr, x, y, font_name, text, 'center', wrap_width)